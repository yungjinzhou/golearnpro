...
func main() {
	...
	fmt.Println(trie.Search("orange")) // 输出: true
	fmt.Println(trie.Search("grape"))  // 输出: false

	// 判断前缀是否存在
	fmt.Println(trie.StartsWith("app")) // 输出: true
	fmt.Println(trie.StartsWith("ban")) // 输出: true
	fmt.Println(trie.StartsWith("ora")) // 输出: true
	fmt.Println(trie.StartsWith("gr"))  // 输出: false

	// 获取前缀出现的次数
	fmt.Println(trie.PassCnt("app")) // 输出: 1
	fmt.Println(trie.PassCnt("ban")) // 输出: 1
	fmt.Println(trie.PassCnt("ora")) // 输出: 1
	fmt.Println(trie.PassCnt("gr"))  // 输出: 0

	// 删除单词
	fmt.Println(trie.Erase("apple"))  // 输出: true
	fmt.Println(trie.Search("apple")) // 输出: false
}
